...
export function ImageBubbleMenu({ editor }: ImageBubbleMenuProps) {
    ...
    useEffect(() => {
        ...
        const updateSelection = () => {
            ...
            const selected = selection instanceof NodeSelection && selection.node.type.name === "image";
    ...
    const handleDelete = async () => {
        ...
        if (imageSrc && imageSrc.includes("supabase.co/storage")) {
            try {
                ...
                const pathMatch = url.pathname.match(/\/storage\/v1\/object\/(?:public|sign)\/images\/(.+)/);
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-2 flex items-center gap-2">
                <div className="flex items-center gap-1 border-r border-gray-200 pr-2">
                    <button
                        ...
                        className={`p-2 rounded transition-colors ${editor.getAttributes("image").align === "left"
                    ...
                    <button
                        ...
                        className={`p-2 rounded transition-colors ${!editor.getAttributes("image").align || editor.getAttributes("image").align === "center"
                            ? "bg-blue-100 text-blue-700"
                            : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                            }`}
                        title="Align center"
                    ...
                    <button
                        ...
                        className={`p-2 rounded transition-colors ${editor.getAttributes("image").align === "right"
                            ? "bg-blue-100 text-blue-700"
                            : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                            }`}
                        title="Align right"
