...
export const TemplateSubtitleExtension = Node.create<TemplateSubtitleOptions>({
    ...
    addAttributes() {
        return {
            subtitle: {
                ...
                parseHTML: (element) => element.textContent?.trim() || "A subtitle for your article",
        ...
        return [
            {
                ...
                getAttrs: (node) => {
                    ...
                    const subtitle = element.getAttribute("data-subtitle") || element.textContent?.trim() || "A subtitle for your article";
                    return {
                        subtitle,
                    };
                },
    ...
    addNodeView() {
        return ({ node, HTMLAttributes, getPos, editor }) => {
            ...
            subtitleInput.className = "template-subtitle bg-transparent block w-full min-w-[200px] focus:outline-none focus:ring-1 focus:ring-blue-500 rounded px-1";
            ...
            // Handle updates
            const updateNode = () => {
                const newSubtitle = subtitleInput.value.trim() || "A subtitle for your article";
