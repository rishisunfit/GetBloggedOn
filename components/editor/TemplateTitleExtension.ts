...
export const TemplateTitleExtension = Node.create<TemplateTitleOptions>({
    ...
    addAttributes() {
        return {
            title: {
                ...
                parseHTML: (element) => element.textContent?.trim() || "Untitled Article",
        ...
        return [
            {
                ...
                getAttrs: (node) => {
                    ...
                    const title = element.getAttribute("data-title") || element.textContent?.trim() || "Untitled Article";
                    return {
                        title,
                    };
                },
    ...
    addNodeView() {
        return ({ node, HTMLAttributes, getPos, editor }) => {
            ...
            titleInput.className = "template-title bg-transparent block w-full min-w-[200px] focus:outline-none focus:ring-1 focus:ring-blue-500 rounded px-1";
