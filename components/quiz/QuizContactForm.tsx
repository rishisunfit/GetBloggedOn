...
export function QuizContactForm({ settings, styles, onSubmit, onSkip }: QuizContactFormProps) {
  ...
  const validate = () => {
    ...
    if (settings.fields.name?.enabled && settings.fields.name.required && !formData.name.trim()) {
    ...
    if (settings.fields.phone?.enabled && settings.fields.phone.required && !formData.phone.trim()) {
          ...
          {settings.fields.name?.enabled && (
            <div>
              <label 
                ...
                style={{ color: styles.textColor }}
              >
                Name {settings.fields.name.required && <span style={{ color: styles.accentColor }}>*</span>}
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  style={{
                    ...
                    border: `2px solid ${errors.name ? '#ef4444' : `${styles.textColor}15`}`,
          ...
          {settings.fields.email?.enabled && (
            <div>
              <label 
                ...
                style={{ color: styles.textColor }}
              >
                Email {settings.fields.email.required && <span style={{ color: styles.accentColor }}>*</span>}
              </label>
              <div className="relative">
                <Mail 
                  size={18} 
                ...
                <input
                  ...
                  style={{
                    backgroundColor: styles.cardBackgroundColor,
                    borderRadius: getBorderRadius(),
                    border: `2px solid ${errors.email ? '#ef4444' : `${styles.textColor}15`}`,
                    color: styles.textColor,
                    fontFamily: styles.fontFamily,
                  }}
                />
          ...
          {settings.fields.phone?.enabled && (
            <div>
              <label 
                ...
                style={{ color: styles.textColor }}
              >
                Phone {settings.fields.phone.required && <span style={{ color: styles.accentColor }}>*</span>}
              </label>
              <div className="relative">
                <Phone 
                  size={18} 
                ...
                <input
                  ...
                  style={{
                    backgroundColor: styles.cardBackgroundColor,
                    borderRadius: getBorderRadius(),
                    border: `2px solid ${errors.phone ? '#ef4444' : `${styles.textColor}15`}`,
                    color: styles.textColor,
                    fontFamily: styles.fontFamily,
                  }}
                />
