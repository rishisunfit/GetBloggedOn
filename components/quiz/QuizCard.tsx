          ...
          question.options?.map((option, index) => (
            <button
              ...
              style={{
                ...
                border: `2px solid ${isSelected(option.id) ? styles.secondaryColor : `${styles.textColor}15`}`,
            ...
            {question.type === 'text' ? (
              <textarea
                ...
                style={{
                  ...
                  borderRadius: getBorderRadius(),
                  border: `2px solid ${textValue ? styles.secondaryColor : `${styles.textColor}15`}`,
                  color: styles.textColor,
              ...
              <input
                ...
                value={textValue}
                onChange={(e) => handleTextChange(e.target.value)}
                placeholder={question.placeholder || (question.type === 'email' ? 'email@example.com' : '(555) 123-4567')}
          ...
          <div className="flex justify-center gap-2 md:gap-4 py-4">
            {[1, 2, 3, 4, 5].map((rating) => (
              <button
                ...
                style={{
                  color: (answer?.value as number) >= rating 
                    ? '#f59e0b'
                    : `${styles.textColor}30`,
                }}
              >
                <Star 
                  size={36} 
                  fill={(answer?.value as number) >= rating ? 'currentColor' : 'none'}
                  strokeWidth={1.5}
                />
              </button>
            ))}
