    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="flex items-center justify-between px-8 py-4 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-[#1a1f4e] tracking-tight">
            ainbox
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link
            href="#"
            className="text-sm text-gray-600 hover:text-[#1a1f4e] transition-colors"
          >
            Why Ainbox?
          </Link>
          <Link
        ...
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-72 h-64">
              ...
              <svg viewBox="0 0 300 250" className="w-full h-full">
                ...
                />
                <path
                  d="M50 130 Q56 115 62 130"
                  stroke="#1a1f4e"
                  strokeWidth="2"
                  fill="none"
                />
                <path
                  d="M48 135 Q56 125 64 135"
                  stroke="#1a1f4e"
                  strokeWidth="2"
                  fill="none"
                />
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-gray-600 mb-8 max-w-md">
              Bloggish turns your best content into a quiet conversion engine.
              Start for free.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-bold text-[#1a1f4e] mb-3">
                Conversion Signals
              </h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Identify what holds attention and what converts, then refine
                with clarity.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Publish once and refine over time. Your best content keeps
                working long after it's live.
              </p>
            </div>
            ...
            <div className="text-center">
              <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center">
                <svg viewBox="0 0 64 64" className="w-16 h-16">
                  ...
                  />
                  <path
                    d="M24 32 Q32 38 40 32"
                    fill="none"
                    stroke="#1a1f4e"
                    strokeWidth="2"
                  />
                  <path
                    d="M20 40 L20 56 L44 56 L44 40"
                    fill="none"
                    stroke="#1a1f4e"
                    strokeWidth="2"
                  />
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                See how readers move, pause, and drop off with heatmaps and
                scroll metrics.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              Our platform provides you with pre-built templates, pre-defined
              segments, and one-click automations, ensuring a quick and seamless
              setup. With our user-friendly design tools, crafting stunning
              campaigns that showcase your brand is effortless, placing it front
              and center in the hearts of your audience.
            </p>
            <p className="text-gray-600 text-sm leading-relaxed mb-8">
              From start to finish, we're here to support your marketing journey
              and help you achieve extraordinary results. Let's collaborate and
        ...
        <div className="max-w-3xl mx-auto px-8">
          ...
          <div className="space-y-6">
            <Link href="#" className="flex items-center gap-4 group">
              <span className="text-[#1a1f4e] group-hover:translate-x-1 transition-transform">
                →
              </span>
              <span className="font-semibold text-[#1a1f4e] group-hover:underline">
